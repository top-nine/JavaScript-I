...
{"id":45,"car_make":"Audi","car_model":"TT","car_year":2008},// To help us use arrays with real world problems we are going to simulate a used car dealer that has 50 cars in their inventory.
...
let carModels = inventory.sort((a, b) => (a.car_model > b.car_model) ? 1 : -1).forEach(car=>console.log(car.car_model));
// ==== Challenge 4 ====
...
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = 0;
console.log(inventory[-1].car_make, inventory[-1].car_model);
